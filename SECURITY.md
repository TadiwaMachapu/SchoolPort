...
- **Assignment scope is class-level, not class-subject-level.** A teacher's assignment visibility is scoped to their classes rather than their specific class-subjects — a refinement, not a leak.
